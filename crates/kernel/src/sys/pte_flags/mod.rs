// ported from https://github.com/theseus-os/Theseus/blob/theseus_main/kernel/pte_flags/src/lib.rs
...
cfg_if! { if #[cfg(any(target_arch = "x86_64", doc))] {
    mod pte_x86_64;
    pub use pte_x86_64::PteFlagsX86_64;
}}
...
cfg_if! { if #[cfg(target_arch = "x86_64")] {
    pub use pte_x86_64::PteFlagsX86_64 as PteFlagsArch;
    pub use pte_x86_64::PTE_FRAME_MASK;
} else if #[cfg(target_arch = "aarch64")] {
    pub use pte_aarch64::PteFlagsAarch64 as PteFlagsArch;
    pub use pte_aarch64::PTE_FRAME_MASK;
}}
...
impl PteFlags {
    ...
    pub const fn new() -> Self {
        Self::from_bits_truncate(Self::ACCESSED.bits | Self::NOT_EXECUTABLE.bits)
    }
